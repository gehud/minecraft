...
namespace Minecraft.Systems {
    ...
    public struct ChunkMeshDataJob : IJob {
                ...
                for (int y = 0; y < Chunk.Size; y++) {
                    for (int z = 0; z < Chunk.Size; z++) {
                        ...
                        if (HasFace(localVoxelCoordinate + new int3(1, 0, 0), voxel.Type)) {
                            ...
                            var u1 = faceTexturing.x * uvStep + uvStep * 0.0f;
                            var u2 = faceTexturing.x * uvStep + uvStep * 0.0f;
                            var u3 = faceTexturing.x * uvStep + uvStep * 1.0f;
                            var u4 = faceTexturing.x * uvStep + uvStep * 1.0f;

                            var v1 = faceTexturing.y * uvStep + uvStep * 0.0f;
                            var v2 = faceTexturing.y * uvStep + uvStep * 1.0f;
                            var v3 = faceTexturing.y * uvStep + uvStep * 1.0f;
                            var v4 = faceTexturing.y * uvStep + uvStep * 0.0f;
                            ...
                            Vertices.Add(new Vertex(x + 1.0f, y + 0.0f, z + 0.0f, u1, v1, lr1, lg1, lb1, ls1));
                            Vertices.Add(new Vertex(x + 1.0f, y + 1.0f, z + 0.0f, u2, v2, lr2, lg2, lb2, ls2));
                            Vertices.Add(new Vertex(x + 1.0f, y + 1.0f, z + 1.0f, u3, v3, lr3, lg3, lb3, ls3));
                            Vertices.Add(new Vertex(x + 1.0f, y + 0.0f, z + 1.0f, u4, v4, lr4, lg4, lb4, ls4));
                        }
                        ...
                        if (HasFace(localVoxelCoordinate + new int3(-1, 0, 0), voxel.Type)) {
                            ...
                            AddFaceIndices(aof1, aof2, aof3, aof4);
                            Vertices.Add(new Vertex(x + 0.0f, y + 0.0f, z + 1.0f, u1, v1, lr1, lg1, lb1, ls1));
                            Vertices.Add(new Vertex(x + 0.0f, y + 1.0f, z + 1.0f, u2, v2, lr2, lg2, lb2, ls2));
                            Vertices.Add(new Vertex(x + 0.0f, y + 1.0f, z + 0.0f, u3, v3, lr3, lg3, lb3, ls3));
                            Vertices.Add(new Vertex(x + 0.0f, y + 0.0f, z + 0.0f, u4, v4, lr4, lg4, lb4, ls4));
                        }
                        ...
                        if (HasFace(localVoxelCoordinate + new int3(0, 1, 0), voxel.Type)) {
                            ...
                            AddFaceIndices(aof1, aof2, aof3, aof4);
                            Vertices.Add(new Vertex(x + 0.0f, y + 1.0f, z + 0.0f, u1, v1, lr1, lg1, lb1, ls1));
                            Vertices.Add(new Vertex(x + 0.0f, y + 1.0f, z + 1.0f, u2, v2, lr2, lg2, lb2, ls2));
                            Vertices.Add(new Vertex(x + 1.0f, y + 1.0f, z + 1.0f, u3, v3, lr3, lg3, lb3, ls3));
                            Vertices.Add(new Vertex(x + 1.0f, y + 1.0f, z + 0.0f, u4, v4, lr4, lg4, lb4, ls4));
                        }
                        ...
                        if (HasFace(localVoxelCoordinate + new int3(0, -1, 0), voxel.Type)) {
                            ...
                            AddFaceIndices(aof1, aof2, aof3, aof4);
                            Vertices.Add(new Vertex(x + 1.0f, y + 0.0f, z + 0.0f, u1, v1, lr1, lg1, lb1, ls1));
                            Vertices.Add(new Vertex(x + 1.0f, y + 0.0f, z + 1.0f, u2, v2, lr2, lg2, lb2, ls2));
                            Vertices.Add(new Vertex(x + 0.0f, y + 0.0f, z + 1.0f, u3, v3, lr3, lg3, lb3, ls3));
                            Vertices.Add(new Vertex(x + 0.0f, y + 0.0f, z + 0.0f, u4, v4, lr4, lg4, lb4, ls4));
                        }
                        ...
                        if (HasFace(localVoxelCoordinate + new int3(0, 0, 1), voxel.Type)) {
                            ...
                            AddFaceIndices(aof1, aof2, aof3, aof4);
                            Vertices.Add(new Vertex(x + 1.0f, y + 0.0f, z + 1.0f, u1, v1, lr1, lg1, lb1, ls1));
                            Vertices.Add(new Vertex(x + 1.0f, y + 1.0f, z + 1.0f, u2, v2, lr2, lg2, lb2, ls2));
                            Vertices.Add(new Vertex(x + 0.0f, y + 1.0f, z + 1.0f, u3, v3, lr3, lg3, lb3, ls3));
                            Vertices.Add(new Vertex(x + 0.0f, y + 0.0f, z + 1.0f, u4, v4, lr4, lg4, lb4, ls4));
                        }
                        ...
                        if (HasFace(localVoxelCoordinate + new int3(0, 0, -1), voxel.Type)) {
                            ...
                            AddFaceIndices(aof1, aof2, aof3, aof4);
                            Vertices.Add(new Vertex(x + 0.0f, y + 0.0f, z + 0.0f, u1, v1, lr1, lg1, lb1, ls1));
                            Vertices.Add(new Vertex(x + 0.0f, y + 1.0f, z + 0.0f, u2, v2, lr2, lg2, lb2, ls2));
                            Vertices.Add(new Vertex(x + 1.0f, y + 1.0f, z + 0.0f, u3, v3, lr3, lg3, lb3, ls3));
                            Vertices.Add(new Vertex(x + 1.0f, y + 0.0f, z + 0.0f, u4, v4, lr4, lg4, lb4, ls4));
                        }
                    }
                }
            }
        ...
        private void AddFaceIndices(float aof1, float aof2, float aof3, float aof4, bool force = false) {
