...
namespace Minecraft {
	public struct ChunkUpdateJob {
		...
		private delegate void AddIndices(float aof1, float aof2, float aof3, float aof4, bool force = false);

		public ChunkUpdateJob(World world, Chunk chunk, BlockProvider blockProvider) {
			OpaqueVertices = new();
			OpaqueIndices = new();
		...
		bool HasFace(int x, int y, int z, bool isLiquid, BlockType blockType, Vector3Int localBlockCoordinate) {
			return IsVoxelTransparent(x, y, z) && GetBlock(x, y, z) != blockType ||
				isLiquid && (y - localBlockCoordinate.y == 1 && GetBlock(x, y, z) != blockType || y == localBlockCoordinate.y && GetBlock(x, y, z) == blockType && GetLiquidAmount(localBlockCoordinate.x, localBlockCoordinate.y + 1, localBlockCoordinate.z, blockType) != 0 && GetLiquidAmount(x, y, z, blockType) != LiquidMap.MAX);
		}
		...
		private unsafe void RenderBlock(int x, int y, int z, BlockType blockType, AddIndices addIndices, List<Vertex> vertices) {
			...
			// Right face.
			if (HasFace(x + 1, y, z, false, blockType, localBlockCoordinate)) {
				...
				var uv1 = new Vector2(atlasPosition.x + 0 * atlasStep, atlasPosition.y + 0 * atlasStep);
				var uv2 = new Vector2(atlasPosition.x + 0 * atlasStep, atlasPosition.y + 1 * atlasStep);
				var uv3 = new Vector2(atlasPosition.x + 1 * atlasStep, atlasPosition.y + 1 * atlasStep);
				var uv4 = new Vector2(atlasPosition.x + 1 * atlasStep, atlasPosition.y + 0 * atlasStep);
				...
				lock (lockObject) {
					addIndices(aof1, aof2, aof3, aof4);
					vertices.Add(Pack(x + 1, y + 0, z + 0, uv1.x, uv1.y, lr1, lg1, lb1, ls1, 0));
					vertices.Add(Pack(x + 1, y + 1, z + 0, uv2.x, uv2.y, lr2, lg2, lb2, ls2, 0));
					vertices.Add(Pack(x + 1, y + 1, z + 1, uv3.x, uv3.y, lr3, lg3, lb3, ls3, 0));
					vertices.Add(Pack(x + 1, y + 0, z + 1, uv4.x, uv4.y, lr4, lg4, lb4, ls4, 0));
				}
			}
			...
			if (HasFace(x - 1, y, z, false, blockType, localBlockCoordinate)) {
				...
				lock (lockObject) {
					addIndices(aof1, aof2, aof3, aof4);
					vertices.Add(Pack(x + 0, y + 0, z + 1, uv1.x, uv1.y, lr1, lg1, lb1, ls1, 0));
					vertices.Add(Pack(x + 0, y + 1, z + 1, uv2.x, uv2.y, lr2, lg2, lb2, ls2, 0));
					vertices.Add(Pack(x + 0, y + 1, z + 0, uv3.x, uv3.y, lr3, lg3, lb3, ls3, 0));
					vertices.Add(Pack(x + 0, y + 0, z + 0, uv4.x, uv4.y, lr4, lg4, lb4, ls4, 0));
				}
			}

			// Top face.
			if (HasFace(x, y + 1, z, false, blockType, localBlockCoordinate)) {
				...
				lock (lockObject) {
					addIndices(aof1, aof2, aof3, aof4);
					vertices.Add(Pack(x + 0, y + 1, z + 0, uv1.x, uv1.y, lr1, lg1, lb1, ls1, 0));
					vertices.Add(Pack(x + 0, y + 1, z + 1, uv2.x, uv2.y, lr2, lg2, lb2, ls2, 0));
					vertices.Add(Pack(x + 1, y + 1, z + 1, uv3.x, uv3.y, lr3, lg3, lb3, ls3, 0));
					vertices.Add(Pack(x + 1, y + 1, z + 0, uv4.x, uv4.y, lr4, lg4, lb4, ls4, 0));
				}
			}
			...
			if (HasFace(x, y - 1, z, false, blockType, localBlockCoordinate)) {
				...
				lock (lockObject) {
					addIndices(aof1, aof2, aof3, aof4);
					vertices.Add(Pack(x + 1, y + 0, z + 0, uv1.x, uv1.y, lr1, lg1, lb1, ls1, 0));
					vertices.Add(Pack(x + 1, y + 0, z + 1, uv2.x, uv2.y, lr2, lg2, lb2, ls2, 0));
					vertices.Add(Pack(x + 0, y + 0, z + 1, uv3.x, uv3.y, lr3, lg3, lb3, ls3, 0));
					vertices.Add(Pack(x + 0, y + 0, z + 0, uv4.x, uv4.y, lr4, lg4, lb4, ls4, 0));
				}
			}

			// Front face.
			if (HasFace(x, y, z + 1, false, blockType, localBlockCoordinate)) {
				...
				lock (lockObject) {
					addIndices(aof1, aof2, aof3, aof4);
					vertices.Add(Pack(x + 1, y + 0, z + 1, uv1.x, uv1.y, lr1, lg1, lb1, ls1, 0));
					vertices.Add(Pack(x + 1, y + 1, z + 1, uv2.x, uv2.y, lr2, lg2, lb2, ls2, 0));
					vertices.Add(Pack(x + 0, y + 1, z + 1, uv3.x, uv3.y, lr3, lg3, lb3, ls3, 0));
					vertices.Add(Pack(x + 0, y + 0, z + 1, uv4.x, uv4.y, lr4, lg4, lb4, ls4, 0));
				}
			}
			...
			if (HasFace(x, y, z - 1, false, blockType, localBlockCoordinate)) {
				...
				lock (lockObject) {
					addIndices(aof1, aof2, aof3, aof4);
					vertices.Add(Pack(x + 0, y + 0, z + 0, uv1.x, uv1.y, lr1, lg1, lb1, ls1, 0));
					vertices.Add(Pack(x + 0, y + 1, z + 0, uv2.x, uv2.y, lr2, lg2, lb2, ls2, 0));
					vertices.Add(Pack(x + 1, y + 1, z + 0, uv3.x, uv3.y, lr3, lg3, lb3, ls3, 0));
					vertices.Add(Pack(x + 1, y + 0, z + 0, uv4.x, uv4.y, lr4, lg4, lb4, ls4, 0));
				}
			}
		}

		private unsafe void RenderLiquid(int x, int y, int z, BlockType blockType, AddIndices addIndices, List<Vertex> vertices) {
			var localBlockCoordinate = new Vector3Int(x, y, z);
			var blockData = blockProvider.Get(blockType);
			bool isTwoSided = blockData.IsTwoSided;
			float atlasStep = 16.0f / 256.0f;
			...
			float h1 = (aown + a180 + a270 + (nsb180 | nsb270) * a225) / 9.0f / (1 + nsb180 + nsb270 + (nsb180 | nsb270) * nsb225);
			float h2 = (aown + a180 + a090 + (nsb180 | nsb090) * a135) / 9.0f / (1 + nsb180 + nsb090 + (nsb180 | nsb045) * nsb135);
			float h3 = (aown + a090 + a000 + (nsb090 | nsb000) * a045) / 9.0f / (1 + nsb090 + nsb000 + (nsb090 | nsb000) * nsb045);
			float h4 = (aown + a000 + a270 + (nsb000 | nsb270) * a315) / 9.0f / (1 + nsb000 + nsb270 + (nsb000 | nsb315) * nsb315);
			...
			// Right face.
			if (HasFace(x + 1, y, z, true, blockType, localBlockCoordinate)) {
				Vector2 atlasPosition = (Vector2)blockData.TexturingData.RightFace * atlasStep;
				...
				var uv1 = new Vector2(atlasPosition.x + 0 * atlasStep, atlasPosition.y + hbtm1 * atlasStep);
				var uv2 = new Vector2(atlasPosition.x + 0 * atlasStep, atlasPosition.y + h4n * atlasStep);
				var uv3 = new Vector2(atlasPosition.x + 1 * atlasStep, atlasPosition.y + h3n * atlasStep);
				var uv4 = new Vector2(atlasPosition.x + 1 * atlasStep, atlasPosition.y + hbtm2 * atlasStep);
				...
				lock (lockObject) {
					addIndices(aof1, aof2, aof3, aof4);
					vertices.Add(Pack(x + 1, y + hbtm1, z + 0, uv1.x, uv1.y, lr1, lg1, lb1, ls1, dir));
					vertices.Add(Pack(x + 1, y + h4n, z + 0, uv2.x, uv2.y, lr2, lg2, lb2, ls2, dir));
					vertices.Add(Pack(x + 1, y + h3n, z + 1, uv3.x, uv3.y, lr3, lg3, lb3, ls3, dir));
					vertices.Add(Pack(x + 1, y + hbtm2, z + 1, uv4.x, uv4.y, lr4, lg4, lb4, ls4, dir));
				}
			}
			...
			if (HasFace(x - 1, y, z, true, blockType, localBlockCoordinate)) {
				...
				var uv1 = new Vector2(atlasPosition.x + 0.0f * atlasStep, atlasPosition.y + hbtm1 * atlasStep);
				var uv2 = new Vector2(atlasPosition.x + 0.0f * atlasStep, atlasPosition.y + h2n * atlasStep);
				var uv3 = new Vector2(atlasPosition.x + 1.0f * atlasStep, atlasPosition.y + h1n * atlasStep);
				var uv4 = new Vector2(atlasPosition.x + 1.0f * atlasStep, atlasPosition.y + hbtm2 * atlasStep);
				...
				lock (lockObject) {
					addIndices(aof1, aof2, aof3, aof4);
					vertices.Add(Pack(x + 0, y + hbtm1, z + 1, uv1.x, uv1.y, lr1, lg1, lb1, ls1, dir));
					vertices.Add(Pack(x + 0, y + h2n, z + 1, uv2.x, uv2.y, lr2, lg2, lb2, ls2, dir));
					vertices.Add(Pack(x + 0, y + h1n, z + 0, uv3.x, uv3.y, lr3, lg3, lb3, ls3, dir));
					vertices.Add(Pack(x + 0, y + hbtm2, z + 0, uv4.x, uv4.y, lr4, lg4, lb4, ls4, dir));
				}
			}

			// Top face.
			if (HasFace(x, y + 1, z, true, blockType, localBlockCoordinate)) {
				var atlasPosition = (Vector2)blockData.TexturingData.TopFace * atlasStep;
				...
				bool fliped = lqt045 || lqt225;
				lock (lockObject) {
					addIndices(aof1, aof2, aof3, aof4, fliped);
					vertices.Add(Pack(x + 0, y + h1n, z + 0, uv1.x, uv1.y, lr1, lg1, lb1, ls1, dir));
					vertices.Add(Pack(x + 0, y + h2n, z + 1, uv2.x, uv2.y, lr2, lg2, lb2, ls2, dir));
					vertices.Add(Pack(x + 1, y + h3n, z + 1, uv3.x, uv3.y, lr3, lg3, lb3, ls3, dir));
					vertices.Add(Pack(x + 1, y + h4n, z + 0, uv4.x, uv4.y, lr4, lg4, lb4, ls4, dir));
				}
			}
			...
			if (HasFace(x, y - 1, z, true, blockType, localBlockCoordinate)) {
				...
				lock (lockObject) {
					addIndices(aof1, aof2, aof3, aof4);
					vertices.Add(Pack(x + 1, y + 0, z + 0, uv1.x, uv1.y, lr1, lg1, lb1, ls1, dir1));
					vertices.Add(Pack(x + 1, y + 0, z + 1, uv2.x, uv2.y, lr2, lg2, lb2, ls2, dir2));
					vertices.Add(Pack(x + 0, y + 0, z + 1, uv3.x, uv3.y, lr3, lg3, lb3, ls3, dir3));
					vertices.Add(Pack(x + 0, y + 0, z + 0, uv4.x, uv4.y, lr4, lg4, lb4, ls4, dir4));
				}
			}

			// Front face.
			if (HasFace(x, y, z + 1, true, blockType, localBlockCoordinate)) {
				var atlasPosition = (Vector2)blockData.TexturingData.BackFace * atlasStep;
				...
				var uv1 = new Vector2(atlasPosition.x + 0.0f * atlasStep, atlasPosition.y + hbtm1 * atlasStep);
				var uv2 = new Vector2(atlasPosition.x + 0.0f * atlasStep, atlasPosition.y + h3n * atlasStep);
				var uv3 = new Vector2(atlasPosition.x + 1.0f * atlasStep, atlasPosition.y + h2n * atlasStep);
				var uv4 = new Vector2(atlasPosition.x + 1.0f * atlasStep, atlasPosition.y + hbtm2 * atlasStep);
				...
				lock (lockObject) {
					addIndices(aof1, aof2, aof3, aof4);
					vertices.Add(Pack(x + 1, y + hbtm1, z + 1, uv1.x, uv1.y, lr1, lg1, lb1, ls1, dir));
					vertices.Add(Pack(x + 1, y + h3n, z + 1, uv2.x, uv2.y, lr2, lg2, lb2, ls2, dir));
					vertices.Add(Pack(x + 0, y + h2n, z + 1, uv3.x, uv3.y, lr3, lg3, lb3, ls3, dir));
					vertices.Add(Pack(x + 0, y + hbtm2, z + 1, uv4.x, uv4.y, lr4, lg4, lb4, ls4, dir));
				}
			}
			...
			if (HasFace(x, y, z - 1, true, blockType, localBlockCoordinate)) {
				...
				var uv1 = new Vector2(atlasPosition.x + 0.0f * atlasStep, atlasPosition.y + hbtm1 * atlasStep);
				var uv2 = new Vector2(atlasPosition.x + 0.0f * atlasStep, atlasPosition.y + h1n * atlasStep);
				var uv3 = new Vector2(atlasPosition.x + 1.0f * atlasStep, atlasPosition.y + h4n * atlasStep);
				var uv4 = new Vector2(atlasPosition.x + 1.0f * atlasStep, atlasPosition.y + hbtm2 * atlasStep);
				...
				lock (lockObject) {
					addIndices(aof1, aof2, aof3, aof4);
					vertices.Add(Pack(x + 0, y + hbtm1, z + 0, uv1.x, uv1.y, lr1, lg1, lb1, ls1, dir));
					vertices.Add(Pack(x + 0, y + h1n, z + 0, uv2.x, uv2.y, lr2, lg2, lb2, ls2, dir));
					vertices.Add(Pack(x + 1, y + h4n, z + 0, uv3.x, uv3.y, lr3, lg3, lb3, ls3, dir));
					vertices.Add(Pack(x + 1, y + hbtm2, z + 0, uv4.x, uv4.y, lr4, lg4, lb4, ls4, dir));
				}
			}
		}

		private void RenderVegetation(int x, int y, int z, BlockType blockType) {
			var blockData = blockProvider.Get(blockType);
		...
		private unsafe void Execute(int index) {
			...
			if (blockProvider.Get(blockType).IsVegetation) {
				RenderVegetation(x, y, z, blockType);
			} else if (blockType != BlockType.Air) {
				AddIndices addIndices = null;
				List<Vertex> vertices = null;
				if (blockProvider.Get(blockType).IsTransparent) {
					addIndices = AddTransparentFaceIndices;
					vertices = TransparentVertices;
				} else {
					addIndices = AddOpaqueFaceIndices;
					vertices = OpaqueVertices;
				}
				if (blockProvider.Get(blockType).IsLiquid) {
					RenderLiquid(x, y, z, blockType, addIndices, vertices);
				} else {
					RenderBlock(x, y, z, blockType, addIndices, vertices);
				}
			}
		}
	}
